...
<section class="our-services" id="services">
	<h1>Our Services</h1>
	<p class="text-center">Realtor and Real Estate Consultant for all kind of Real Estate.</p>
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<div class="serv-img">
			...
			<div class="col-md-6">
				<div class="serv-info">
					<div class="serv-details">
						...
						<p class="serv">Realtor and Real Estate Consultant for all kind of Real Estate.</p>
					</div>
					<div class="serv-details">
...
<!-- <section class="price bg-3" id="pricing">
	<h3 class="text-center">Check Out Our Latest Prooerties</h3>
	<p class="text-center">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
	<div class="container">
		<div class="row">
				...
				<section class="pricing-section">
					<div class="pricing pricing--jinpa">
						<div class="pricing__item">
							...
							<div class="pricing__price"><span class="pricing__currency">&#x20A6</span>1000</div>
				...
				<section class="pricing-section">
					<div class="pricing pricing--jinpa">
						<div class="pricing__item">
							...
							<div class="pricing__price"><span class="pricing__currency">&#x20A6</span>2000</div>
				...
				<section class="pricing-section">
					<div class="pricing pricing--jinpa">	
						<div class="pricing__item">
							...
							<div class="pricing__price"><span class="pricing__currency">&#x20A6</span>3000</div>
